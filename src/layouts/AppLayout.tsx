    ...
    <>
          ...
          <div className="row">
            ...
            <div className="col d-flex align-items-center justify-content-end justify-content-md-center">
              <nav className="d-md-flex align-items-center d-sm-none">
                ...
                <Link to="/services/makeup-course">Makeup Course</Link>
          ...
          <div className="row">
            <div className="col">
              ...
              <nav className="d-flex flex-column align-items-start">
                ...
                <Link to="/services/makeup-course" onClick={closeMenu}>Makeup Course</Link>
      ...
      <footer className="text-center bg-dark-grey">
        <div className="container-fluid boxed">
          <div className="row">
            <div className="col">
              <p className="mb-0 text-white">&copy; 2026 - Brenda Mello Makeup</p>
            </div>
          </div>
        </div>
      </footer>
